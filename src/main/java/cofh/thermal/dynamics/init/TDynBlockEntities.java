...
public class TDynBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<?>> ITEM_BUFFER_BLOCK_ENTITY = TILE_ENTITIES.register(ID_ITEM_BUFFER, () -> BlockEntityType.Builder.of(ItemBufferBlockEntity::new, BLOCKS.get(ID_ITEM_BUFFER)).build(null));
