...
import static cofh.thermal.dynamics.init.TDynReferences.LOGISTICS_ITEM_BUFFER_BLOCK;
...
public class TDynBlocks {
    ...
    private static void registerTileBlocks() {
        ...
        registerBlock(ID_LOGISTICS_ITEM_BUFFER, () -> new TileBlock6Way(create(Material.IRON).sound(SoundType.NETHERITE).hardnessAndResistance(2.0F).harvestTool(ToolType.PICKAXE), LogisticsItemBufferTile::new));
    ...
    private static void registerTileEntities() {
        ...
        TILE_ENTITIES.register(ID_LOGISTICS_ITEM_BUFFER, () -> TileEntityType.Builder.create(LogisticsItemBufferTile::new, LOGISTICS_ITEM_BUFFER_BLOCK).build(null));
