...
public class ItemTurboServoAttachmentScreen extends ContainerScreenCoFH<ItemTurboServoAttachmentMenu> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(PATH_GUI + "generic.png");

    public static final String TEX_EXTRACT = ID_THERMAL + ":textures/gui/elements/info_extract_to_item_grid.png";
    ...
    protected final ItemServoAttachment attachment;

    public ItemTurboServoAttachmentScreen(ItemTurboServoAttachmentMenu container, Inventory inv, Component titleIn) {
        super(container, inv, titleIn);

        texture = TEXTURE;
        attachment = container.attachment;
        info = generatePanelInfo("info.thermal.item_turbo_servo_attachment");
    }
