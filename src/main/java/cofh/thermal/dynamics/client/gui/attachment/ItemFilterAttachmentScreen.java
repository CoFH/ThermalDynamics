...
public class ItemFilterAttachmentScreen extends ContainerScreenCoFH<ItemFilterAttachmentMenu> {
    ...
    protected final ItemFilterAttachment attachment;

    public ItemFilterAttachmentScreen(ItemFilterAttachmentMenu container, Inventory inv, Component titleIn) {
