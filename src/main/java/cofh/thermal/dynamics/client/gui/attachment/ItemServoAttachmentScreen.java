...
public class ItemServoAttachmentScreen extends ContainerScreenCoFH<ItemServoAttachmentMenu> {
    ...
    public ItemServoAttachmentScreen(ItemServoAttachmentMenu container, Inventory inv, Component titleIn) {
        super(container, inv, titleIn);

        texture = TEXTURE;
        attachment = container.attachment;
        info = generatePanelInfo("info.thermal.item_servo_attachment");
    }
