...
public class FluidInputFilterAttachmentScreen extends ContainerScreenCoFH<FluidInputFilterAttachmentContainer> {
    ...
    protected final FluidInputFilterAttachment attachment;

    public FluidInputFilterAttachmentScreen(FluidInputFilterAttachmentContainer container, Inventory inv, Component titleIn) {

        super(container, inv, titleIn);

        texture = TEXTURE;
        attachment = container.attachment;
        info = generatePanelInfo("info.thermal.fluid_input_filter_attachment");
    }
